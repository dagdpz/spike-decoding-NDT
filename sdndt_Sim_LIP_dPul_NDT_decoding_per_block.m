function [raster_data, raster_labels, raster_site_info] = sdndt_Sim_LIP_dPul_NDT_decoding_per_block(mat_filename, target_state, target_brain_structure)
...
% sdndt_Sim_LIP_dPul_NDT_decoding_per_block('Y:\Projects\Simultaneous_dPul_PPC_recordings\ephys\dPul_LIP_Lin_20211109\population_Linus_20211109.mat');
...
for u = 1:num_units
    ...
    for b = unique_blocks
        ...
        if num_block_trials > 0
            ...
            filename = [OUTPUT_PATH_raster population(u).unit_ID '_raster_' raster_site_info.target '_block_' num2str(b) '_trial_state_' target_state_name '.mat'];
            save(filename, 'raster_data', 'raster_labels', 'raster_site_info');
        end
    end
